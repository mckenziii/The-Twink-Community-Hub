--[[ ============================================================================
     ...
     an embedded reanimation engine, an online + custom animation browser, an
     emote wheel, and a live theming system shared with the main hub.
     ...
     SECTION MAP (search the ==== banners to jump):
      ...
      10. EMOTE WHEEL      radial emote menu + mobile button
      11. WIRING + BOOT    theme sweep, parenting, startup

     BRANDING NOTE: user-facing names and _G globals use "twinkhub"/"Twink".
     The onyxv2.lol URLs are live asset endpoints (animations, audio, icons)
     and are intentionally left as-is — they are not branding.
============================================================================ ]]
...
local presetList = {
    ["Freestylin'"] = "https://onyxv2.lol/Animations/Freestylin%27.lua",
    ["Floss"] = "https://onyxv2.lol/Animations/Floss.lua", 
    ["Orange Justice"] = "https://onyxv2.lol/Animations/Orange%20Justice.lua",
    ["Take The L"] = "https://onyxv2.lol/Animations/takethel.lua",
    ["Default Dance"] = "https://onyxv2.lol/Animations/Default%20Dance.lua",
    ["Gangnam Style"] = "https://onyxv2.lol/Animations/Gangnam%20Style.lua",
    ["Macarena"] = "https://onyxv2.lol/Animations/Macarena.lua",
    ["Thriller"] = "https://onyxv2.lol/Animations/Thriller.lua",
    ["Moonwalk"] = "https://onyxv2.lol/Animations/Moonwalk.lua",
    ["Robot"] = "https://onyxv2.lol/Animations/Robot.lua",
    ["Twerk"] = "https://onyxv2.lol/Animations/Twerk.lua",
    ["Dab"] = "https://onyxv2.lol/Animations/Dab.lua",
    ["Salute"] = "https://onyxv2.lol/Animations/Salute.lua",
    ["Wave"] = "https://onyxv2.lol/Animations/Wave.lua",
    ["Clap"] = "https://onyxv2.lol/Animations/Clap.lua",
    ["Cheer"] = "https://onyxv2.lol/Animations/Cheer.lua",
    ["Laugh"] = "https://onyxv2.lol/Animations/Laugh.lua",
    ["Point"] = "https://onyxv2.lol/Animations/Point.lua",
    ["Shrug"] = "https://onyxv2.lol/Animations/Shrug.lua",
    ["Swim"] = "https://onyxv2.lol/Animations/Swim.lua",
    ["Sit"] = "https://onyxv2.lol/Animations/Sit.lua",
    ["Lay Down"] = "https://onyxv2.lol/Animations/Lay%20Down.lua",
    ["Sleep"] = "https://onyxv2.lol/Animations/Sleep.lua",
    ["Crouch"] = "https://onyxv2.lol/Animations/Crouch.lua",
    ["Pray"] = "https://onyxv2.lol/Animations/Pray.lua",
    ["Meditation"] = "https://onyxv2.lol/Animations/Meditation.lua"
}
local AnimationList      = {}
...
local _lastAnimCheck = 0
    ...
    mobileBtnGui.Name = "TwinkMobileWheelBtn"
    ...
    pcall(function()
        ...
        if raw then
            ...
            if data and (data.enabled == true or data.enabled == 1) then
                mobileEnabled = true
                _G._TwinkMobileWheelEnabled = true
    ...
    local function doMobileToggle()
        ...
        _G._TwinkMobileWheelEnabled = mobileEnabled
        ...
        if _G._TwinkUpdateMobileBtnText then pcall(_G._TwinkUpdateMobileBtnText) end
    end

    _G._TwinkToggleMobileWheel = doMobileToggle
    _G._TwinkMobileWheelEnabled = mobileEnabled
...
-- Ensure local audio and icons cache directories exist
        ...
        local function playEmoteAudio(emoteName)
            ...
            task.spawn(function()
                local url = "https://onyxv2.lol/audio/" .. game:GetService("HttpService"):UrlEncode(emoteName) .. ".mp3"
                local assetId = getLocalAsset(url, audioFolder, emoteName .. ".mp3")
                if assetId and audioSession == session then
                    pcall(function()
                        local sound = Instance.new("Sound")
                        sound.Name = "TwinkEmoteSound"
        ...
        local function playClickSound()
            task.spawn(function()
                local assetId = getLocalAsset("https://onyxv2.lol/audio/Click.mp3", audioFolder, "Click.mp3")
                if assetId then
                    pcall(function()
                        local sound = Instance.new("Sound")
                        sound.Name = "TwinkClickSound"
                        sound.SoundId = assetId
                        sound.Volume = 0.2
                        sound.Parent = game:GetService("SoundService")
                        sound:Play()
        ...
        -- ====================================================================
        -- 10. EMOTE WHEEL — radial hold-to-open emote menu (Fortnite-style)
        -- ====================================================================
        ...
        task.spawn(function()
            ...
            local url = "https://i.postimg.cc/JzbXQrW0/onyxwheel.png"
            local assetId = getLocalAsset(url, iconsFolder, "onyxwheel.png")
            if assetId then
        ...
        local drawWheel = function()
            ...
            for i, emoteName in ipairs(emotes) do
                ...
                task.spawn(function()
                    local url = "https://onyxv2.lol/icons/" .. game:GetService("HttpService"):UrlEncode(emoteName) .. ".png"
        ...
        triggerEmote = function(emoteName)
            ...
            task.spawn(function()
                ...
                if actualAnimName and animUrl then
                    ...
                    local fallbackUrl = "https://onyxv2.lol/Animations/" .. game:GetService("HttpService"):UrlEncode(emoteName) .. ".lua"
        ...
        if _G._TwinkReanimGlobalConns then
            table.insert(_G._TwinkReanimGlobalConns, keyBeganConn)
            table.insert(_G._TwinkReanimGlobalConns, keyEndedConn)
        end
    end)
